...
public class GameController : MonoBehaviour
{
    ...
    GameObject[] currentDengTa;
    public GameObject dengTa;
    ...
    void Start()
    {
        ...
        currentDengTa = new GameObject[2];
        DengTaInit();
    }
    ...
    void DengTaInit()
    {
        for (int i = 0; i < currentDengTa.Length; i++)
        {
            if (currentDengTa[i] == null)
            {
                float tx = 0.0f;
                float tz = 0.0f;
                int j = 0;
                ...
                currentDengTa[i] = (GameObject)Instantiate(dengTa, new Vector3(tx, 0, tz), dengTa.transform.rotation);
            }
        }
    }
